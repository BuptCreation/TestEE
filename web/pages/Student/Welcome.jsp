...
<head>
    ...
    <base href="../../">
    <!--  页面样式导入-->
    <link rel="stylesheet" type="text/css" href="static/css/style-welcome.css">
...
<a href="pages/Student/Welcome.jsp#fake" class="enter">Hello</a>
<div class="page">
    <div class="main">
        ...
        <header class="clearfix">
            <div class='container'>
                <div class="intro">
                    <a href="pages/Student/My.jsp" title="点击进入主页"><h1>Click Here! 让创作更加美好</h1></a>
                    <p></p>
                </div>
            </div>
        </header>
...
<script type="text/javascript" src="static/script/script-welcome.js"></script>
